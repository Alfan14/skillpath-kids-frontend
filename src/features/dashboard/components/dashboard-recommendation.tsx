  ...
  return (
    ...
    >
      ...
      <div className="
        ...
        hover-lift-soft hover:shadow-[0_8px_24px_rgba(0,93,167,0.12)]
      ">
        ...
        <div className="flex flex-1 flex-col items-center gap-4 text-center sm:flex-row sm:text-left">
          <Image
            ...
            width={160}
            height={130}
            className="h-auto w-full max-w-[130px] shrink-0 transition-transform duration-300 group-hover:scale-105 motion-reduce:transition-none motion-reduce:group-hover:scale-100"
          />
          <div>
        ...
        <div className="mt-5">
          <Button
            variant="outline"
            className="press-soft w-full rounded-[18px] border-2 border-primary font-extrabold text-primary hover:bg-primary-container"
            asChild
          >
            <DashboardSoundLink href="/tips">Lihat Panduan</DashboardSoundLink>
          </Button>
        </div>
      </div>
      ...
      <div className="
        ...
        hover-lift-soft hover:shadow-[0_8px_24px_rgba(15,29,36,0.10)]
      ">
        <div className="flex flex-1 flex-col items-center gap-4 text-center sm:flex-row sm:text-left">
          <Image
        ...
        <div className="mt-6">
          <Button
            variant="primary"
            className="press-soft w-full rounded-[18px] bg-primary font-black text-white shadow-[0_5px_0_0_#004883] hover:translate-y-[2px] active:shadow-[0_2px_0_0_#004883]"
            asChild
          >
            <DashboardSoundLink href="/files">Unduh PDF</DashboardSoundLink>
          </Button>
        </div>
      </div>
    </section>
